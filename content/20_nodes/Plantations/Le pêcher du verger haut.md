...
topics:
  ...
  - verger
targets:
  - planting:devey-verger-haut-pecher-001
  - contextual|species:prunus-persica
  - located_in|zone:verger-haut
  - scan_entry|scan:qr-devey-pecher-001
language: fr
version: 1
summary: Ce nœud sert d'entrée par scan vers une plantation précise.
node_kind: node
site: devey
phrase_essence: >
  Ce pêcher n'est pas seulement une espèce ; c'est un individu situé, exposé,
  attendu, pris dans une histoire locale.
card_text: >
  En scannant ce point, on ne lit pas « le pêcher » en général, mais ce
  pêcher-ci : placé ici, dans ce verger, avec cette lumière, cette pente et
  cette promesse.
summary_short: |
